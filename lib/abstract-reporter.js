...
class AbstractReporter {
  ...
  shouldReport (err) {
    if (!err) { return false }
    let order = this.getLevelOrder(this.getLevel(err))
    return order >= this.getLevelOrder(this.reportingLevel)
  }
